cmd_scripts/mod/mk_elfconfig := gcc -Wp,-MD,scripts/mod/.mk_elfconfig.d -O2 -I/builder/shared-workdir/build/staging_dir/host/include  -Wall -Wmissing-prototypes -Wstrict-prototypes   -I/builder/shared-workdir/build/staging_dir/host/include -I./tools/include  -o scripts/mod/mk_elfconfig scripts/mod/mk_elfconfig.c -L/builder/shared-workdir/build/staging_dir/host/lib 
