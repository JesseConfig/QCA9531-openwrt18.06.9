...
enum opt_code
{
  ...
  /* OPT_ftarget_help = 999, */              /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1000,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1001, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1002,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1003,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1004,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1005, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1006,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1007,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1008,                   /* -ftime-report */
  OPT_ftime_report_details = 1009,           /* -ftime-report-details */
  OPT_ftls_model_ = 1010,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1011,              /* -ftoplevel-reorder */
  OPT_ftracer = 1012,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1013,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1014,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1015,                   /* -ftrampolines */
  OPT_ftrapping_math = 1016,                 /* -ftrapping-math */
  OPT_ftrapv = 1017,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1018,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1019,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1020,                      /* -ftree-ccp */
  OPT_ftree_ch = 1021,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1022, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1023,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1024,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1025, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1026,                   /* -ftree-cselim */
  OPT_ftree_dce = 1027,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1028,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1029,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1030,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1031,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1032, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1033,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1034,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1035, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1036,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1037,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1038, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1039,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1040,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1041,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1042,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1043,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1044,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1045,                      /* -ftree-pre */
  OPT_ftree_pta = 1046,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1047,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1048, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1049,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1050,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1051,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1052,                     /* -ftree-slsr */
  OPT_ftree_sra = 1053,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1054, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1055, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1056,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1057,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1058,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1059, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1060,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1061, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1062,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1063,         /* -funconstrained-commons */
  ...
  OPT_fuse_cxa_atexit = 1074,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1075,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1076,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1077,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1078,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1079,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1080,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1081,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1082,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1083,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1084, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1085,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1086,                   /* -fverbose-asm */
  /* OPT_fversion = 1087, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1088,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1089,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1090,                   /* -fvisibility= */
  OPT_fvpt = 1091,                           /* -fvpt */
  /* OPT_fvtable_gc = 1092, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1093, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1094,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1095,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1096,                     /* -fvtv-debug */
  OPT_fweak = 1097,                          /* -fweak */
  OPT_fweb = 1098,                           /* -fweb */
  /* OPT_fwhole_file = 1099, */              /* -fwhole-file */
  OPT_fwhole_program = 1100,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1101,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1102,             /* -fworking-directory */
  OPT_fwpa = 1103,                           /* -fwpa */
  OPT_fwpa_ = 1104,                          /* -fwpa= */
  OPT_fwrapv = 1105,                         /* -fwrapv */
  /* OPT_fxref = 1106, */                    /* -fxref */
  /* OPT_fzee = 1107, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1108,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1109,                     /* -fzero-link */
  OPT_g = 1110,                              /* -g */
  OPT_gant = 1111,                           /* -gant */
  OPT_gcoff = 1112,                          /* -gcoff */
  OPT_gcolumn_info = 1113,                   /* -gcolumn-info */
  OPT_gdwarf = 1114,                         /* -gdwarf */
  OPT_gdwarf_ = 1115,                        /* -gdwarf- */
  OPT_gen_decls = 1116,                      /* -gen-decls */
  OPT_ggdb = 1117,                           /* -ggdb */
  OPT_ggnu_pubnames = 1118,                  /* -ggnu-pubnames */
  OPT_gnat = 1119,                           /* -gnat */
  OPT_gnatO = 1120,                          /* -gnatO */
  OPT_gno_column_info = 1121,                /* -gno-column-info */
  OPT_gno_pubnames = 1122,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1123,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1124,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1125,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1126,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1127,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1128,                   /* -gsplit-dwarf */
  OPT_gstabs = 1129,                         /* -gstabs */
  OPT_gstabs_ = 1130,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1131,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1132,                        /* -gtoggle */
  OPT_gvms = 1133,                           /* -gvms */
  OPT_gxcoff = 1134,                         /* -gxcoff */
  OPT_gxcoff_ = 1135,                        /* -gxcoff+ */
  OPT_gz = 1136,                             /* -gz */
  OPT_gz_ = 1137,                            /* -gz= */
  OPT_h = 1138,                              /* -h */
  OPT_idirafter = 1139,                      /* -idirafter */
  OPT_imacros = 1140,                        /* -imacros */
  OPT_imultiarch = 1141,                     /* -imultiarch */
  OPT_imultilib = 1142,                      /* -imultilib */
  OPT_include = 1143,                        /* -include */
  OPT_iplugindir_ = 1144,                    /* -iplugindir= */
  OPT_iprefix = 1145,                        /* -iprefix */
  OPT_iquote = 1146,                         /* -iquote */
  OPT_iremap = 1147,                         /* -iremap */
