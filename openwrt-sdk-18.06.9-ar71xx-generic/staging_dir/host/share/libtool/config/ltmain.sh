...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/builder/shared-workdir/build/staging_dir/host/bin/grep -E"}
	: ${FGREP="/builder/shared-workdir/build/staging_dir/host/bin/grep -F"}
	: ${GREP="/builder/shared-workdir/build/staging_dir/host/bin/grep"}
	: ${SED="/builder/shared-workdir/build/staging_dir/host/bin/sed"}
fi
